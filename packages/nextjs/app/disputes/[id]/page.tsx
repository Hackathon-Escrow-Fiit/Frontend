              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <img
                      src={blo(d.clientFull)}
                      alt="client"
                      className="w-6 h-6 rounded-full"
                    />
                    <span className="text-sm text-base-content/70">Client (You)</span>
                  </div>
                  <span className="text-sm font-bold text-success">+{d.clientPayout} {d.token}</span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img
                      src={blo(d.freelancerFull)}
                      alt="freelancer"
                      className="w-6 h-6 rounded-full"
                    />
                    <span className="text-sm text-base-content/70">Freelancer</span>
                  </div>
                  <span className="text-sm font-semibold text-base-content/70">+{d.freelancerPayout} {d.token}</span>
                </div>

                <div className="flex items-center justify-between pt-2 border-t border-base-300">
                  <span className="text-xs text-base-content/40">Platform Arbitration Fee</span>
                  <span className="text-xs text-base-content/50">-{d.platformFee} {d.token}</span>
                </div>
              </div>
            </div>
