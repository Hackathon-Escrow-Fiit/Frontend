...
import { getMockDispute, getVotingDeadline } from "~~/app/juror/mockDisputes";
    ...
    <>
      <div className="p-6 pb-28 overflow-auto">
        <div className="flex items-center gap-2 text-sm mb-4">
          <Link href="/disputes/all" className="text-base-content/50 hover:text-primary transition-colors">
            All Disputes
          </Link>
...
export default function DisputeVotePage() {
          ...
          <div className="text-right shrink-0">
            ...
            {expired ? (
              <div className="flex flex-col items-end gap-2">
                ...
                <Link href={`/disputes/${id}/result`} className="btn btn-primary btn-xs gap-1">
                  View Final Result →
                </Link>
              </div>
            ) : (
